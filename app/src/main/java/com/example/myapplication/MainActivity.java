...
public class MainActivity extends AppCompatActivity {
    ...
    String quizData[][] = {
            ...
            {"image_circle", "Circulo", "Triangulo", "Cuadrado", "Hexagono"},
            {"image_triangle", "Triangulo", "Circulo", "Cuadrado", "Pentagono"},
            {"image_square", "Cuadrado", "Triangulo", "Pentagono", "Hexagono"},
            {"image_pentagon", "Pentagono", "Circulo", "Triangle", "Hexagono"},
            {"image_hexagon", "Hexagono", "Triangulo", "Pentagono", "Circulo"},
    };
